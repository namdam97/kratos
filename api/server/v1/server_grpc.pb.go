...
const (
	Server_CreateServer_FullMethodName = "/api.server.v1.Server/CreateServer"
	Server_UpdateServer_FullMethodName = "/api.server.v1.Server/UpdateServer"
	Server_DeleteServer_FullMethodName = "/api.server.v1.Server/DeleteServer"
	Server_GetServer_FullMethodName    = "/api.server.v1.Server/GetServer"
	Server_ListServer_FullMethodName   = "/api.server.v1.Server/ListServer"
)
